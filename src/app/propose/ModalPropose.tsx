...
const ModalPropose: React.FC<ModalProps> = () => {

  const [modalPoliceOpen, setModalPoliceOpen] = useState(false)

  const handlePropose: React.MouseEventHandler<HTMLDivElement> | undefined = ():void => {
...

      {
        ...
        <div className="bg-white p-8 rounded-lg w-96 h-40">
          ...
          <div className='flex items-center justify-center mt-5 text-sm font-bold'>
            <div className='cursor-pointer px-8 py-1 m-3 border-2 border-sygnature-brown text-sygnature-brown rounded-md ' onClick={handlePropose}>
              취소하기
            </div>
